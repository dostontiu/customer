...
<body class="vertical-layout vertical-menu-modern 2-columns navbar-sticky footer-static semi-dark-layout <?=($menuSession==1) ?'dark-layout' : 'pace-done' ?> <?= ($pageSession==1) ?'menu-expanded' : 'menu-collapsed'?>"
